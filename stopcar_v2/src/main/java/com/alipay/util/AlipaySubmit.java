...
public class AlipaySubmit {
	static Logger log  = Logger.getLogger(AlipaySubmit.class);
     ...
     * @return 提交表单HTML文本
     */
    public static String buildRequestget(Map<String, String> sParaTemp) {
        //待请求参数数组
        Map<String, String> sPara = buildRequestPara(sParaTemp);
        List<NameValuePair> params_list = new ArrayList<NameValuePair>();
        //进行POST的组装
        NameValuePair[] params = new NameValuePair[sPara.size()];
        ...
        if(params_list.size() > 0){
        	return doGet(ALIPAY_GATEWAY_NEW,params_list.toArray(params)); 
        }
	 ...
	 * @return
	 */
	public static  String doGet(String url,NameValuePair[] params){
		...
		try{
			...
			if(params!= null){
				...
				System.out.println("QueryString="+get.getQueryString());
			}
