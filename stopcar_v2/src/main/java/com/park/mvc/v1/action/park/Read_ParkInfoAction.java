 ...
 *
 */
public class Read_ParkInfoAction extends BaseV1Action {
	 ...
	 * @return
	 */
	@Action(value = "read_park_info")
	public String 	read_park_info(){
		...
		ReturnDataNew returnData = new ReturnDataNew();
		 try{
			...
			orderBiz.read_park_info(returnData, dtype,pi_id,area_code);
			sendResp(returnData);
			return null;
			
			} catch (Exception e) {
				log.error("Read_ParkInfoAction.read_park_info is error  2.21	Read-读取停车场详情 (APPSDK-JAVA)- P",e);
