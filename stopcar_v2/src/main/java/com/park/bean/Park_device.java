...
public class Park_device implements Cloneable , Serializable{
    ...
    public long pd_id;//BIGINT    
    public long pi_id;//BIGINT    
    public String in_out="";//VARCHAR    出口或者入口入口：enter出口：exit
    public String in_out_code="";//VARCHAR    出入口编号例如（A出口B入口）
    public String camera="";//VARCHAR    摄像头
    public String camera_mac="";//VARCHAR    摄像头MAC
    public String signo_name="";//VARCHAR    道闸名称
    public String solid_garage_mac="";//VARCHAR    立体车库设备MAC
    public String solid_garage_sn="";//VARCHAR    立体车库设备编号
    public java.util.Date ctime=new java.util.Date();//DATETIME    创建时间
    public java.util.Date utime=new java.util.Date();//DATETIME    更新时间
    public String pd_md5="";//VARCHAR    校验MD5(pi_id+in_out+in_out_code+camera_mac+signo_name+solid_garage_mac)
