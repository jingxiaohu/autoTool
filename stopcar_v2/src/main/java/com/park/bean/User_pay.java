...
public class User_pay implements Cloneable , Serializable{
    ...
    //public static String[] carrays ={"id","order_id","transaction_id","type","version_code","system_type","return_url","ui_id","ui_nd","money","act_type","ctime","utime","etime","state","ip","referer","subject","note","car_order_id"};

    public long id;//BIGINT    主键ID
    public String order_id="";//VARCHAR    我的订单
    public String transaction_id="";//VARCHAR    第三方事物单号
    public int type;//INT    支付类型1:支付l宝2：微信3：银联
    public int version_code;//INT    当前手机APP版本号
    public int system_type;//INT    操作系统类型（IOSAndroidweb）1:android2:IOS3:web
    public String return_url="";//VARCHAR    前置页面跳转URL
    public long ui_id;//BIGINT    
    public String ui_nd="";//VARCHAR    
    public long money;//BIGINT    
    public int act_type;//INT    行为类型1：充值2：普通订单支付3：租赁订单支付
    ...
    public int state;//INT    交易状态(0:未支付1：已支付2：支付失败)
    public String ip="";//VARCHAR    IP地址
    public String referer="";//VARCHAR    第三方回调referer
    public String subject="";//VARCHAR    商品名称
    public String note="";//VARCHAR    备注
    public String car_order_id="";//VARCHAR    停车订单号
    ...
    public static User_pay newUser_pay(long id, String order_id, String transaction_id, int type, int version_code, int system_type, String return_url, long ui_id, String ui_nd, long money, int act_type, java.util.Date ctime, java.util.Date utime, java.util.Date etime, int state, String ip, String referer, String subject, String note, String car_order_id) {
