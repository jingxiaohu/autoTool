...
public class Sms_validate implements Cloneable , Serializable{
    ...
    public String v_tel="";//VARCHAR    手机号
    public String v_code="";//VARCHAR    验证码6位数字
    public String v_list="";//VARCHAR    随机码v_code的MD5
    public String v_class="";//VARCHAR    什么类型的短信验证码1：注册2：重置密码3:修改手机
    public long v_time;//BIGINT    验证时间
    public String v_time_str="";//VARCHAR    时间字符串
