...
public class Park_info implements Cloneable , Serializable{
    ...
    public long pi_id;//BIGINT    主键ID
    public String area_code="";//VARCHAR    省市县编号
    public String pi_name="";//VARCHAR    场地名称
    public String address_name="";//VARCHAR    场地地理位置名称
    public double lng;//DOUBLE    场地经度
    public double lat;//DOUBLE    场地纬度
    public String linkman_name="";//VARCHAR    场地联系人姓名
    public String linkman_tel="";//VARCHAR    场地联系人手机
    public String copy_linkman_name="";//VARCHAR    备用联系人姓名
    public String copy_linkman_tel="";//VARCHAR    备用联系人手机
    public String pi_phone="";//VARCHAR    场地座机号
    public String department="";//VARCHAR    负责单位
    public int enter_num;//INT    场地口入数量
    public int exit_num;//INT    场地出口数量
    public int hlc_enter_num;//INT    场地入口道闸数量
    public int hlc_exit_num;//INT    场地出口道闸数
    public int enter_camera_num;//INT    场地入口摄像头数
    public int exit_camera_num;//INT    场地出口摄像头数
    public String camera_info="";//VARCHAR    场地摄像头型号
    ...
    public int is_expect;//INT    是否开启预约0:不开启1：开启
    public int expect_money;//INT    每小时预约费用（单位分）
    public int allow_revoke_time;//INT    允许预约撤单时间(单位分钟)
    public int allow_expect_time;//INT    允许预约时间最大时长(单位分钟)
    public String timeout_info="";//VARCHAR    计费信息首停2小时5元，之后每小时2元
    public String rent_info="";//VARCHAR    租赁计费信息准入时段18:00-08:00，300元/月
    public int month_price;//INT    租赁包月价格
    public int is_rent;//INT    是否开启租赁0:未开启1：已经开启
    public int money;//INT    蓝牌小汽车起步价
    public String loginname="";//VARCHAR    露天停车场帐号
    public String password="";//VARCHAR    露天停车场密码
    public String mac="";//VARCHAR    露天停车场PDAMAC（逗号分割）
    public int is_fault;//INT    停车场故障0:无故障1：发生故障
    public int pi_state;//INT    停车场状态（1开启0关闭）
    public int roadside_type;//INT    占道停车是否按次数收费0:按时间收费1：按次数收费
    public long pu_id;//BIGINT    关联的商户主键ID
    public String pu_nd="";//VARCHAR    商户ND（商户编号）
    public String note="";//VARCHAR    备注
    public int carport_yet;//INT    临停已停车位
    public int carport_space;//INT    临停空车位个数
    public int carport_total;//INT    临停总车位个数
    public int moth_car_num;//INT    租赁离线包月车位总个数
    public int moth_car_num_space;//INT    租赁离线剩余车位数
    public int time_car_num;//INT    时间段包月车位总数
    public int time_car_num_space;//INT    时间段包月车位剩余个数
    public int expect_car_num;//INT    已预约车位数
