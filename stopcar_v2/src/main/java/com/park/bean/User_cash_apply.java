...
public class User_cash_apply implements Cloneable , Serializable{
    ...
    public int state;//INT    提现状态0：未打款1：已打款2：打款失败
    public String bank_no="";//VARCHAR    商户银行卡号
    public String bank_name="";//VARCHAR    开户行名称
    public String bank_sub_name="";//VARCHAR    开户行支行详细名称
    public String name="";//VARCHAR    商户姓名
    public String tel="";//VARCHAR    商户手机号码
