...
public class Sms_running implements Cloneable , Serializable{
    ...
    public int Id;//INT    
    public String sms_tel="";//VARCHAR    
    public String sms_content="";//TEXT    
    public int sms_stat;//INT    失败还是成功1-成功，0失败
    public int sms_type;//INT    1-自定义短信0-程序员自定义短信
    public String sms_user="";//VARCHAR    发送用户
    public String sms_user_name="";//VARCHAR    发送用户
    public String server_state="";//VARCHAR    服务端的状态码
    public String sms_date="";//VARCHAR    
