...
public class China_area implements Cloneable , Serializable{
    ...
    public int id;//INT    
    public String area_code="";//VARCHAR    区/县编号
    public String area_name="";//VARCHAR    区县名称
    public String province_code="";//VARCHAR    省编号
    public String province_name="";//VARCHAR    省或者直辖市名称
    public String city_code="";//VARCHAR    市代码
    public String city_name="";//VARCHAR    市名称
    public String father="";//VARCHAR    市编号
