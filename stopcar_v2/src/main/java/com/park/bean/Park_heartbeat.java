...
public class Park_heartbeat implements Cloneable , Serializable{
    ...
    //public static String[] carrays ={"id","pi_id","area_code","num","total","ctime","ctime_num","is_rent","note","carport_yet","carport_space","carport_total","moth_car_num","moth_car_num_space","time_car_num","time_car_num_space","expect_car_num"};

    public long id;//BIGINT    
    public long pi_id;//BIGINT    停车场主键ID
    public String area_code="";//VARCHAR    省市区编号
    public int num;//INT    库存车辆数
    public int total;//INT    停车位总数
    public java.util.Date ctime=new java.util.Date();//DATETIME    创建时间
    public long ctime_num;//BIGINT    创建时间长整型
    public int is_rent;//INT    是否有租赁包月业务0：没有1：有
    ...
    public static Park_heartbeat newPark_heartbeat(long id, long pi_id, String area_code, int num, int total, java.util.Date ctime, long ctime_num, int is_rent, String note, int carport_yet, int carport_space, int carport_total, int moth_car_num, int moth_car_num_space, int time_car_num, int time_car_num_space, int expect_car_num) {
