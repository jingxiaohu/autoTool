...
public class SignApk {
	public static Logger logger = Logger.getLogger(SignApk.class);
    ...
    private static String readPassword(File keyFile) {
        // use Console.readPassword() when it's available.
     ...
     * @param public_key :公钥
     * @param self_key：私钥
     * @param filePathSrc：需要进行签名的APK路径
     * @param filePathDest：重新签名后的APK保存路劲
     */
    public static void ReSignature(String public_key,String self_key,String filePathSrc,String filePathDest )  throws Exception{
//    	String[] args = new String[]{"d:/platform.x509.pem","d:/platform.pk8", "d:/todaytest/quzhuan.apk", "d:/quzhuanzip/quzhuan.apk"};
//    	String[] args = new String[]{"F:/temp/android.x509.pem","F:/temp/android.pk8", "F:/temp/quzhuan.apk", "F:/temp/quzhuan3.apk"};
    	String[] args = new String[]{public_key,self_key,filePathSrc, filePathDest};
        ...
        try {
            ...
            for(Map.Entry<String, Attributes> dd: map.entrySet()){
            	String key = dd.getKey();
            	if(key.contains("META-INF")){
            		System.out.println(key+"  "+dd.getValue());
