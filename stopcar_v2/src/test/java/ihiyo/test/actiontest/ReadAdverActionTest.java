 ...
 *
 */
public class ReadAdverActionTest extends BaseActionTest{
	...
	public void open() throws Exception{
		...
		//{"url":"http://smaradio1.changhong.com/img/adverUploadFiles/ad_imgfile/201510081444303824ns8l.jpg","errorno":"0","errormsg":"获取成功"}
	}
	/**
	 * 重发验证码
	 * @throws Exception 
	...
	public void index() throws Exception{
		PostMethod post  = new PostMethod(url);
		String Apitype = "index";
		//分类点播
		post.addParameter("Apitype", Apitype);
		String result  = doPost(post);
		//{"urllist":[{"img":"http://smaradio1.changhong.com/img/adverUploadFiles/ad_imgfile/201510081444303824ns8l.jpg","name":"阿斯顿","type":false,"id":0}],"errorno":"0","errormsg":"获取成功"}
	}
